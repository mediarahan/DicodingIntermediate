...
import com.dicoding.firstintermediateandroidsubmission.DataDummy
...
import com.dicoding.firstintermediateandroidsubmission.getOrAwaitValue
...
class MainViewModelTest{
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        Mockito.`when`(userRepository.getStoryList()).thenReturn(expectedStory)
    ...
    fun `when Get Quote Empty Should Return No Data`() = runTest {
        ...
        Mockito.`when`(userRepository.getStoryList()).thenReturn(expectedQuote)
        val mainViewModel = MainViewModel(userRepository)
